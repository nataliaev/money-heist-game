  ...
  return (
    <div className="rules-container">
      ...
      <h2 className="rules-text">
        Today is the main day of your life. <br></br> Your team is inside of the
        Money Heist. <br></br> You can comunicate with them once a day to give
        them tasks to:
      </h2>
      ...
      <div className="people-rules-block">
